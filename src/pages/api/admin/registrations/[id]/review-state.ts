...
export function createReviewStateRoute(options: Options = {}) {
...
export const POST = async (context: any) => {
  try {
    ...
    return createReviewStateRoute({ database: getDatabase(), sessionSecretB64: import.meta.env.ADMIN_SESSION_SECRET_B64 })(context);
  } catch {
    return createReviewStateRoute()(context);
  }
};
